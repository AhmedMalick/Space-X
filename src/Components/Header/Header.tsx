          ...
          <Link to="/#">
            <svg version="1.1" x="0px" y="0px" viewBox="0 0 400 50">
              ...
              <g className="letter_p">
                <path
                  fill="#fff"
                  d="M91.8,18.6H59v30.7h9.3V37.5h24.2c6.7,0,10.4-2.3,10.4-7.7v-3.4C102.8,21.4,98.6,18.6,91.8,18.6z M94.8,28.4c0,2.2-0.4,3.4-4,3.4H68.3l0.1-8h22c4,0,4.5,1.2,4.5,3.3V28.4z"
                ></path>
              </g>
              ...
              <g className="letter_c">
                <path
                  fill="#fff"
                  d="M171.4,23.9h34.8c-0.9-3.6-4.4-5.4-9.4-5.4h-26c-4.5,0-8.8,1.8-8.8,6.7v17.2c0,4.9,4.3,6.7,8.8,6.7h26.3c6,0,8.1-1.7,9.1-5.8h-34.8V23.9z"
                ></path>
              </g>
